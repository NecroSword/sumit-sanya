...
export default function App() {
  ...
  const [who, setWhoState] = useState(() => localStorage.getItem('ka_who') || 'Sumit')
        ...
        <RoleContext.Provider value={{ isVisitor }}>
          <div style={{
            ...
            <header style={styles.topbar}>
              <div style={styles.topbarTitle}>Sumit & Sanya 💕</div>
            ...
            <Modal open={showWhoModal} onClose={() => who && setShowWhoModal(false)} title="Who's using the app? 💕">
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                <button style={styles.bigWhoBtn} onClick={() => selectWho('Sumit')}>
                  <div style={{ fontSize: '2rem', marginBottom: 6 }}>💙</div>
                  <strong>Sumit</strong>
                </button>
                <button style={styles.bigWhoBtn} onClick={() => selectWho('Sanya')}>
                  <div style={{ fontSize: '2rem', marginBottom: 6 }}>🌸</div>
                  <strong>Sanya</strong>
                </button>
              </div>
